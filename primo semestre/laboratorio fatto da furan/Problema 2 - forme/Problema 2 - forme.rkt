...
;; Croce regolare
(define croce-regolare
  (lambda (bigTile1 bigTile2 smolTile1 smolTile2)
    (glue-tiles bigTile1 (glue-tiles (glue-tiles (shift-down (shift-right (half-turn bigTile2) 2) 1) (shift-right smolTile1 2)) (shift-right (shift-down (half-turn smolTile2) 5) 2)))
  ))

;; Test
(croce-regolare larger-tile larger-tile smaller-tile smaller-tile)

;; Quadrato inclinato
(define quadrato-inclinato
  (lambda (bigTile1 bigTile2 smolTile1 smolTile2)
    (glue-tiles (half-turn bigTile1) (glue-tiles (shift-down (shift-right bigTile2 2) 1) (glue-tiles (shift-right (half-turn smolTile1) 2) (shift-right (shift-down smolTile2 5) 2))))
    ))

;; Test
(quadrato-inclinato larger-tile larger-tile smaller-tile smaller-tile)